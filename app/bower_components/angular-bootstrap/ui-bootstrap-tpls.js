...
.directive('uibTabset', function() {
  return {
    ...
    link: function(scope, element, attrs) {
      ...
      scope.solid = angular.isDefined(attrs.solid) ? scope.$parent.$eval(attrs.solid) : false;
      scope.tabContentClass = angular.isDefined(attrs.tabcontentclass) ? attrs.tabcontentclass : "";
      scope.tabLinkClass = angular.isDefined(attrs.tablinkclass) ? attrs.tablinkclass : "";
    }
  };
})
...
angular.module("template/tabs/tabset.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/tabs/tabset.html",
    "<div>\n" +
    "  <ul class=\"nav nav-{{type || 'tabs'}} {{tabLinkClass}}\" ng-class=\"{'nav-stacked': vertical, 'nav-justified': justified, 'nav-tabs-solid':solid }\" ng-transclude></ul>\n" +
